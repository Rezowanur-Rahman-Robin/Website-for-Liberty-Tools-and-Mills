...
<?php 
    ...
    if(isset($_GET['edit_p_cat'])){
        ...
        $edit_p_cat_query = "select * from product_cat where cat_id='$edit_p_cat_id'";
...
<?php  
          ...
          if(isset($_POST['update'])){
              ...
              $update_p_cat = "update product_cat set cat_title='$p_cat_title' where cat_id='$p_cat_id'";
              ...
              if($run_p_cat){
                ...
                echo "<script>alert('Your Product Category is failed to Update!')</script>";
              }
