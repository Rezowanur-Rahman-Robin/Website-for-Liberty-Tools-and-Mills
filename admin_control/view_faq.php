    ...
    <div class="col-lg-12"><!-- col-lg-12 begin -->
        <ol class="breadcrumb"><!-- breadcrumb begin -->
            <li>
                ...
                <i class="fa fa-dashboard"></i> Dashboard / View FAQ
        ...
        <div class="panel panel-default"><!-- panel panel-default begin -->
            <div class="panel-heading"><!-- panel-heading begin -->
                <h3 class="panel-title"><!-- panel-title begin -->
                    ...
                    <i class="fa fa-tags fa-fw"></i> View FAQ
                    ...
                    <table class="table table-hover table-striped table-bordered"><!-- tabel tabel-hover table-striped table-bordered begin -->
                        ...
                        <tbody><!-- tbody begin -->
                            ...
                            <tr><!-- tr begin -->
                                ...
                                <td> 
                                    <a href="index.php?edit_faq= <?php echo $faq_id; ?> " class="btn btn-info">
                                        <i class="fa fa-pencil"></i> Edit
                                    </a>
                                </td>
                                <td> 
                                    <a href="index.php?delete_faq= <?php echo $faq_id; ?> " class="btn btn-danger">
