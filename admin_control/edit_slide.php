...
<?php 
    ...
    if(isset($_GET['edit_slide'])){
        ...
        $edit_slide = "select * from slide where slide_id='$edit_slide_id'";
        ...
        <div class="panel panel-default"><!-- panel panel-default begin -->
            <div class="panel-heading"><!-- panel-heading begin -->
               ...
               <div class="alert alert-info">
                <strong>Warning!</strong> Slide Image Size should be 1920 X 660 px.
                </div>
                ...
                <form action="" class="form-horizontal" method="post" enctype="multipart/form-data"><!-- form-horizontal begin -->
                    ...
                    <div class="form-group"><!-- form-group begin -->
                        ...
                        <div class="col-md-6"><!-- col-md-6 begin -->
                            ...
                            <img src="../pic/<?php echo $slide_image; ?>" class="img-responsive">
...
<?php  
    ...
    if(isset($_POST['update'])){
        ...
        if(empty($slide_image)){
            ...
            $get_slide = "select * from slide where slide_id=$slide_id";
                                    
            $run_slide = mysqli_query($con,$get_slide);
    
            if($row_slide=mysqli_fetch_array($run_slide)){
        ...
        move_uploaded_file($temp_name,"../pic/$slide_image");
        
        $update_slide = "update slide set slide_name='$slide_name',slide_image='$slide_image' where slide_id='$slide_id'";
        ...
        if($run_update_slide){
            ...
            echo "<script>alert('Slide Updating Failed!')</script>"; 
