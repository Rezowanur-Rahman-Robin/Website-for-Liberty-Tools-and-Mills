...
<?php 
    ...
    if(isset($_GET['user_profile'])){
        ...
        $user_contact = $row_user['admin_phn'];
               ...
               <form method="post" class="form-horizontal" enctype="multipart/form-data"><!-- form-horizontal Begin -->
                   ...
                   <div class="form-group"><!-- form-group Begin -->
                      ...
                      <div class="col-md-6"><!-- col-md-6 Begin -->
                          ...
                          <input value="<?php echo $user_email; ?>"  name="admin_email" type="text" class="form-control">
                   ...
                   <div class="form-group"><!-- form-group Begin -->
                      ...
                      <div class="col-md-6"><!-- col-md-6 Begin -->
                          ...
                          <img src="admin_images/<?php echo  $user_image; ?>" alt="<?php echo $admin_name; ?>" width="90" height="90">
                   ...
                   <div class="form-group"><!-- form-group Begin -->
                      ...
                      <div class="col-md-6"><!-- col-md-6 Begin -->
                          ...
                          <textarea  name="admin_about" class="form-control" rows="8"><?php echo $admin_about; ?></textarea>
...
if(isset($_POST['update'])){
    ...
    $update_user = "update admins set admin_name='$user_name',admin_email='$user_email',admin_pass='$user_pass',admin_phn='$user_contact',admin_about='$user_about',admin_image='$user_image' where admin_id='$user_id'";
    ...
    if($run_user){
        ...
        echo "<script>alert('Profile Editing Failed!')</script>";
    }
